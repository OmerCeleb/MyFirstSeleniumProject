...
//        Open the workbook using fileinputstream
        try {
            ...
            Workbook workbook = WorkbookFactory.create(fileInputStream); // top open the Excel sheet
...
//        Go to 3rd row 2nd cell-chain the row and cell
            String r3s2 = sheet1.getRow(2).getCell(1).toString();
            System.out.println("Third row, second cell: " + r3s2);

//        Find the number of row
            int numOfRows = sheet1.getLastRowNum();  // returns all used rows without header
            System.out.println("numOfRows = " + numOfRows);

//        Find the number of used row
            int totalRows = sheet1.getPhysicalNumberOfRows(); // returns all rows including header
